...
const AppMenuButton = Backbone.View.extend({
    ...
    initialize(args) {
        ...
        this.$recorder = $('<div class="jmv-ribbon-appmenu-item action">Screen Capture</div>').appendTo(this.$content);
