...
function allFunctions($functionsContent) {
    ...
    descriptions.VMEAN = { label: 'VMEAN( <i>variable</i>, group_by=0 )', content: 'Returns the overall mean of a variable.' };
    $functionsContent.append($('<div class="item" data-name="VMED">VMED</div>'));
    descriptions.VMED = { label: 'VMED( <i>variable</i>, group_by=0 )', content: 'Returns the median of a variable.' };
    $functionsContent.append($('<div class="item" data-name="VMIN">VMIN</div>'));
    descriptions.VMIN = { label: 'VMIN( <i>variable</i>, group_by=0 )', content: 'Returns the smallest value of a variable.' };
    $functionsContent.append($('<div class="item" data-name="VMODE">VMODE</div>'));
    descriptions.VMODE = { label: 'VMODE( <i>variable</i>, group_by=0 )', content: 'Returns the most common value in a variable.' };
    $functionsContent.append($('<div class="item" data-name="VN">VN</div>'));
    descriptions.VN = { label: 'VN( <i>variable</i>, group_by=0 )', content: 'Returns the number of cases in a variable.' };
    $functionsContent.append($('<div class="item" data-name="VSE">VSE</div>'));
    descriptions.VSE = { label: 'VSE( <i>variable</i>, group_by=0 )', content: 'Returns the standard error of the mean of a variable.' };
    $functionsContent.append($('<div class="item" data-name="VSTDEV">VSTDEV</div>'));
    descriptions.VSTDEV = { label: 'VSTDEV( <i>variable</i>, group_by=0 )', content: 'Returns the standard deviation of a variable.' };
    $functionsContent.append($('<div class="item" data-name="VSUM">VSUM</div>'));
    descriptions.VSUM = { label: 'VSUM( <i>variable</i>, group_by=0 )', content: 'Returns the overall sum of a variable.' };
