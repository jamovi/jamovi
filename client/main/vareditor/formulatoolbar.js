...
function allFunctions($functionsContent) {
    ...
    descriptions.VMAX = { label: 'VMAX( <i>variable</i> )', content: 'Returns the largest value of a variable.' };
    ...
    descriptions.VMIN = { label: 'VMIN( <i>variable</i> )', content: 'Returns the smallest value of a variable.' };
