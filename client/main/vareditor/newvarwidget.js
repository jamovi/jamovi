...
const NewVarWidget = Backbone.View.extend({
    ...
    initialize(args) {
        ...
        this.$data = $('<button class="button data-variable"></button>').appendTo(this.$container);
        this.$iconData = $('<div class="icon"</div>').appendTo(this.$data);
        this.$data.append($(`<div class="text">${_('New data variable')}</div>`));

        this.$computed = $('<button class="button computed-variable"></button>').appendTo(this.$container);
        ...
        this.$recoded = $('<button class="button transformed-variable"></button>').appendTo(this.$container);
