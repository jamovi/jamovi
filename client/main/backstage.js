...
var BackstageModel = Backbone.Model.extend({
    ...
    createOps: function() {
        ...
        if (mode === 'demo') {
            open_thispc = { name: 'thispc', title: 'This PC', model: { title: 'Opening files from your PC', msg: `Not currently available in this online demo`}, view: InDevelopmentView };
            import_thispc = { name: 'thispc', title: 'This PC', model: { title: 'Importing data from your PC', msg: `Not currently available in this online demo`}, view: InDevelopmentView };
            saveAs_thispc = { name: 'thispc', title: 'This PC', separator: true, model: { title: 'Saving data to your PC', msg: `Not currently available in this online demo`}, view: InDevelopmentView };
            export_thispc = { name: 'thispc', title: 'This PC', separator: true, model: { title: 'Exporting data to your PC', msg: `Not currently available in this online demo`}, view: InDevelopmentView };
        }
        else {
