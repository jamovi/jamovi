...
class Instance:
    ...
    #     create_task(self._perform())

    # async def _perform(self):

    #     requests = [
    #         b"\x08\x01\x18\x012,\n'\x08\x01\x12\x07estados \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01",
    #         b'\x08\x01\x18\x012>\n9\x08\x02\x12\x19propor\xc3\xa7\xc3\xa3o de exodontias \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012(\n#\x08\x03\x12\x03IDH \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012&\n!\x08\x03\x12\x03IDH \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012<\n7\x08\x02\x12\x19propor\xc3\xa7\xc3\xa3o de exodontias \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012$\n\x1f\x18\x01 \x01(\x010\x028\x01\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\xb8\x01\x02\x80\x01\x01',
    #         b'\x08\x01\x18\x0120\n+\x08\t\x12\x0bpopula\xc3\xa7\xc3\xa3o \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012$\n\x1f\x18\x01 \x01(\x010\x028\x01\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\xb8\x01\x02\x80\x01\x01',
    #         b'\x08\x01\x18\x012:\n5\x08\n\x12\x15taxa de analfabetismo \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0128\n3\x08\n\x12\x15taxa de analfabetismo \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0128\n3\x08\n\x12\x15taxa de analfabetismo \x01(\x020\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012.\n)\x08\t\x12\x0bpopula\xc3\xa7\xc3\xa3o \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0128\n3\x08\x02\x12\x15taxa de analfabetismo \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012<\n7\x08\n\x12\x19propor\xc3\xa7\xc3\xa3o de exodontias \x01(\x020\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0128\n3\x08\x02\x12\x15taxa de analfabetismo \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012#\n\x1e\x08\x04 \x02(\x010\x048\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012#\n\x1e\x08\x05 \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012\n\n\x05\x08\x04\xb8\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012#\n\x1e\x08\x06 \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012$\n\x1f\x08\x05\x12\x01G \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0123\n.\x08\x05\x12\x10renda per capita \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0124\n/\x08\x06\x12\x0f\xc3\xadndice de Gini \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0123\n.\x08\x05\x12\x10Renda Per Capita \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0128\n3\x08\x02\x12\x15Taxa de Analfabetismo \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012.\n)\x08\t\x12\x0bPopula\xc3\xa7\xc3\xa3o \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012<\n7\x08\n\x12\x19Propor\xc3\xa7\xc3\xa3o de Exodontias \x01(\x020\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x0122\n-\x08\x06\x12\x0f\xc3\xadndice de Gini \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012#\n\x1e\x08\x07 \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012C\n>\x08\x07\x12\x1eCobertura Populacional por ESB \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b'\x08\x01\x18\x012A\n<\x08\x07\x12\x1eCobertura Populacional por ESB \x01(\x010\x04@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01',
    #         b"\x08\x01\x18\x012,\n'\x08\x01\x12\x07Estados \x01(\x010\x028\x01@d\x88\x01\x01\x90\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x98\x01\x01\x80\x01\x01",
    #         b'\x08\x01\x10\x01"\xbf\x01\x10\x01\x18\x04 \x010\x01:\xb4\x010.676\r\n0.736\r\n0.69\r\n0.771\r\n0.684\r\n0.792\r\n0.737\r\n0.806\r\n0.774\r\n0.698\r\n0.7\r\n0.734\r\n0.814\r\n0.762\r\n0.7\r\n0.71\r\n0.728\r\n0.731\r\n0.688\r\n0.699\r\n0.771\r\n0.742\r\n0.769\r\n0.719\r\n0.691\r\n0.702\r\n0.69',

    #     ]

    #     await sleep(1)

    #     for req_bin in requests:
    #         request = jcoms.DataSetRR()
    #         request.ParseFromString(req_bin)
        ...
        for data_item in data_list:
            ...
            if column.data_type == DataType.DECIMAL:
                ...
                for j in range(row_count):
                    ...
                    log.debug('%i %i %s', j, row_no, value)
                    log.debug('%s', column.levels)
                ...
                for j in range(row_count):
                    ...
                    log.debug('%s', value)
                    log.debug('%s', column.levels)
                    log.debug('%s', column.data_type)
                    log.debug('%s', column.measure_type)
                    ...
                    if value is None or value == '':
                        ...
                        if column.measure_type == MeasureType.ID:
                            ...
                            index += 1
                            log.debug('inserting level %s %s %s - %s', index, value, str(index), column.levels)
                            column.insert_level(index, value, str(index))
                        log.debug('setting %i %i', row_no, index)
                        column.set_value(row_no, index)
                        log.debug('set')
                    else:
                        raise RuntimeError('Should not get here')
