...
if include_server:
    ...
    packages += [
        ...
        'jamovi.server.formatio.pyreadstat_pipeline',
        'jamovi.server.formatio.pyreadstat_pipeline.pipeline',
        'jamovi.server.formatio.pyreadstat_pipeline.data_types',
        'jamovi.server.formatio.pyreadstat_pipeline.pipeline.infer_metadata',
        'jamovi.server.formatio.pyreadstat_pipeline.pipeline.pass_one',
        'jamovi.server.formatio.pyreadstat_pipeline.pipeline.pass_two',
        'jamovi.server.formatio.pyreadstat_pipeline.pipeline.pass_one_finalize',
        'jamovi.server.utils',
